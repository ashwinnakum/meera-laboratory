...
export default function ServiceCard({ service, index = 0, compact = false }) {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -6 }}
      className="group relative bg-white rounded-2xl p-7 md:p-8 shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 overflow-hidden"
    >
      {/* Gradient border top */}
      ...
      <div className="relative z-10">
        <div className="w-14 h-14 bg-gradient-to-br from-primary/10 to-accent/10 rounded-xl flex items-center justify-center mb-5 group-hover:from-primary/15 group-hover:to-accent/15 transition-colors duration-300">
